<section class="registermodal">
	<div id="modal2" class="modal">
	    <div class="modal-content center">
	      ...
	      <h5><small class="center" id="reg_error" style="color: #800080;"></small></h5>
	      <form>
	    ...
	    <div class="row">
		  ...
		  <a href="javascript:void(0)" id="submit_reg" class="waves-effect waves-light btn" style="background: #800080 !important;">Register</a>
